% Map Stereo MTI
function [R_final, t_final, P_MTI_tform, P_Stereo_tform] = STEREO_MTI_MAP(P_MTI_3d, P_STEREO_3d)
    ...
    % P_MTI_3d = P_MTI_3d * R_subx;
     ...
     %% Change for stereo 3d 
    R_suby = [1, 0, 0; 
            0, -1, 0;
            0, 0, 1];
    % P_STEREO_3d = P_STEREO_3d * R_subx * R_suby; 
    
    %% change rotation of the moving object
    fixed = P_MTI_3d;
    moving = P_STEREO_3d * R_subx * R_suby;
%     R_move = rotx(180); 
